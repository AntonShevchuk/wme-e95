...
(function () {
  ...
  class E95 extends WMEBase {
    ...
    detectCity (segment) {
      ...
      //  W.selectionManager.getSelectedFeatures()[0].attributes.repositoryObject.getConnectedSegments().map(x => x.attributes.id)
      //  W.selectionManager.getSelectedFeatures()[0].attributes.repositoryObject.getConnectedSegmentsByDirection().map(x => x.attributes.id)
      //  when it will work
